...
class ComplexTaichi extends StatelessWidget {
  const ComplexTaichi(
      {super.key,
      this.size = 300,
      this.color1 = const Color.fromARGB(255, 13, 26, 46),
      this.color2 = const Color.fromARGB(255, 176, 232, 243)});
  final double size;
  final Color color1;
  final Color color2;
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          ...
                          colors: [
                            const Color.fromARGB(255, 41, 62, 67),
                            color1
                          ]),
